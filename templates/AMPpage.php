...
<head>
    ...
    <title><?php print($AMPpage['title']); ?></title>
    <link rel="canonical" href="<?php print($AMPpage['permalink']); ?>"/>
    <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">
    <script type="application/ld+json">
      {
        "@context": "http://schema.org",
        "@type": "BlogPosting",
        "headline": "<?php print($AMPpage['title']); ?>",
        "mainEntityOfPage": "<?php print($AMPpage['permalink']); ?>",
        "author": {
          "@type": "Person",
        ...
        "image": {
          "@type": "ImageObject",
          "url": "<?php print($AMPpage['imgData']['url']); ?>",
          "width": "<?php print($AMPpage['imgData']['width']); ?>",
          "height": "<?php print($AMPpage['imgData']['height']); ?>"
        },
         "publisher": {
          "@type": "Organization",
          "name": "<?php print($AMPpage['publisher']); ?>",
          "logo": {
            "@type": "ImageObject",
            "url": "<?php print($AMPpage['LOGO']); ?>",
            "width": 60,
            "height": 60
          }
        },
        "description": "<?php print($AMPpage['desc']); ?>"
      }
                </script>
...
<article class="post"><h1 class="title"><?php print($AMPpage['title']); ?></h1>
    <div class="entry-content">
        <?php print($AMPpage['AMPtext']); ?>
    </div>
