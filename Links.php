...
//    }
    ...
    if (empty(Helper::options()->plugin('AMP')->baiduAPI)) {
        throw new Typecho_Widget_Exception('未设置 快速收录接口地址!');
    } else {
        //熊掌号下线后换成了快速收录  2020.06.07 修改此处为快速收录 接口
        //默认为快速收录的接口地址
    ...
    <div class="main">
        <div class="body container">
            ...
            <div class="row typecho-page-main" role="main">
                ...
                <div>
                    <p>本页将所选类型的地址批量提交到百度的 普通收录 资源提交接口</p>
                    ...
                    <p>
                        3.熊掌号（已下线），是百度熊掌号是内容和服务提供者入驻百度生态的实名账号。通过历史内容接口，每天可提交最多500万条有价值的内容，所提交内容会进入百度搜索统一处理流程。请先设置好APPID和TOKEN后再进行提交。</p>
                    <p></p>
